...
import { useUpdateUserProfileInfoMutation, useViewUserProfileInfoQuery } from "../../redux/features/user/userApi";
...
const ProfileForm = () => {
    ...
    const { id } = useAppSelector((state: RootState) => state.auth as { id: string });
